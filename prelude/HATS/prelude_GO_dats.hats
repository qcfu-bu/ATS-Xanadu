...
VERTICAL SLICE (in progress): only gint000 is wired; the remaining 13 modules
are added as the slice is proven.  See srcgen2/xats2go/docs/01-cats-go-prelude.md.
*)
(* ****** ****** *)
//
#staload // XTOP
