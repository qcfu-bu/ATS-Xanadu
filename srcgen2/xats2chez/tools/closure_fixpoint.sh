...
RT="$HERE/../../srcgen1/prelude/DATS/CATS/CHEZ/xats2chez_cats.scm $HERE/../../srcgen1/prelude/DATS/CATS/CHEZ/xats2chez_runtime.scm $HERE/../../srcgen1/prelude/DATS/CATS/CHEZ/xats2chez_collrt.scm $HERE/../../srcgen1/prelude/DATS/CATS/CHEZ/xats2chez_generics.scm"
UNITS="$(grep -vE '^\s*#|^\s*$' "$1")"
