...
Status: **M2 IN PROGRESS** — M2.0–M2.5 ✅; **M2.6a ✅ (i1tnm→i0typ side-table — computed temps now concretely typed; 0 `any` in emitted programs)** · M2.6b (value-typed tuples/records) **next — pivotal** · M0/M1 done · Go 1.26.4. **suite = 34/34 GREEN.**
