...
|I1INSdapp(iv0, ivs) =>
  ...
  // (tmpw retirement 2026-08-27: the strn_foritm callee exception is gone
  // -- the resolved-instance call references its callee temp like any
  // other dapp, so the callee counts.)
