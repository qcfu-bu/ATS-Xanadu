...
(* ****** ****** *)
//
// xats2go MIGRATION: [I0Etry0] is APPENDED here as the LAST constructor of
// the [i0exp_node] datatype so every PRE-EXISTING constructor keeps its
// source datacon stamp (the JS [XATSCTAG("I0E...",N)] tag).  This lets the
// frontend lower [D3Etry0] (the try..with form) to a real intrep0 node
// (instead of the un-lowered [I0Enone1]) WITHOUT renumbering any other tag,
// so the JS-oracle libs (compiled against the old tag set) stay compatible.
// Shape mirrors xats2js/srcgen1's [I0Etry0 of (token, i0exp, i0clslst)].
//
|I0Etry0 of
(token(*$TRY*)
